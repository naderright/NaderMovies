import { genres, getGenreNames, getNumberOfStars, startLinkImag } from '@/contextAPI/getOptions';
            ...
            <div className="rateAndButtons flex items-end justify-between">
              ...
              <div className="buttonWatchMovie flex  gap-1">
                <div className="WatchNow">
                  <Link className='transition-colors btn bg-primary font-medium hover:bg-hover' href={`/details/${bannerMovie.id}`}>Watch Now</Link>
                </div>
                <div className="viewInfo">
                  <Link className='transition-colors btn border font-thin' href={`/details/${bannerMovie.id}`}>More info</Link>
                </div>
              </div>
