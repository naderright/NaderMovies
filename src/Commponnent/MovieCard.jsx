    ...
    <div className='pt-1 '  >
      <div className="MovieCard bg-white   	" >
        <div className="group transition-all relative ">
          <Image className=' rounded  hover:cursor-pointer w-full' width={200} height={150} priority src={movie.poster_path ? startLinkImag + movie.poster_path : movie.profile_path ? startLinkImag + movie.profile_path : profileImage} alt={movie.name || movie.title} />
          {/* layout Card */}
